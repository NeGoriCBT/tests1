...
function renderForm() {
  ...
  initQuestionNavRail({
    railEl: document.getElementById("hars-rail"),
    form,
    count: HARS_ITEMS.length,
    headingId: (i) => `hars-heading-${i}`,
    isAnswered: (i) => Boolean(form.querySelector(`input[name="hars-${i}"]:checked`)),
  });
}
